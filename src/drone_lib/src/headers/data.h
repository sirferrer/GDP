...
public:
    ...
    geometry_msgs::PointStamped target_position; ///< target position relative to drone
...
private:
    ...
    ros::Subscriber target_position_sub; ///< target position relative to drone

    void target_position_cb(const geometry_msgs::PointStamped::ConstPtr& msg); ///< Callback for target-drone relative xyz
