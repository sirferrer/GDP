...
if(NOT "include;/usr/include;/home/pablo/GDP_Git/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/home/pablo/GDP_Git/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pablo/GDP_Git/install/${idir}'.  ${_report}")
    endif()
